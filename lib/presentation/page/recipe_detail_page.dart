        ...
        children: [
          ...
          Expanded(
            child: GridView.count(
              crossAxisCount: 2,
              // Reduced aspect ratio for more vertical space
              childAspectRatio: 2.0, // Changed from 2.5 to 2.0
              crossAxisSpacing: 12,
              mainAxisSpacing: 12,
              children: [
          ...
          // Disclaimer text remains unchanged
        ],
      ),
    );
  }
  ...
  Widget _buildNutritionCard(String label, String value, IconData icon) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Smaller icon
          Icon(icon, color: AppConstants.primaryColor, size: 18), // Reduced from 20
          const SizedBox(height: 4),
          // Constrained text widgets
          ConstrainedBox(
            constraints: const BoxConstraints(maxHeight: 20), // Height constraint
            child: AutoSizeText(
              value,
              style: AppConstants.bodyStyle.copyWith(
                fontWeight: FontWeight.w600,
          ...
          ConstrainedBox(
            constraints: const BoxConstraints(maxHeight: 16), // Height constraint
            child: AutoSizeText(
              label,
              style: AppConstants.captionStyle.copyWith(
...
''';
  ...
  void _showSnackBar(String message, Color color) {
    if (color == Colors.green || color == AppConstants.secondaryColor) {
      SnackbarUtil.showSuccess(context, message);
    } else if (color == Colors.red) {
      SnackbarUtil.showError(context, message);
    } else if (color == Colors.orange || color == AppConstants.accentColor) {
